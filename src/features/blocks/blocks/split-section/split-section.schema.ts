...
export interface SplitSectionBlockProps {
...
export const splitSectionSchema: BlockSchema = {
	type: "splitSection",
	label: "Sección Dividida (Imagen + Texto)",
	icon: "📐",
	description: "Layout de dos columnas: imagen a un lado, contenido al otro.",
	fields: [
		{
			key: "layout",
...
export const splitSectionDefaultProps: SplitSectionBlockProps = {
	layout: "image-left",
