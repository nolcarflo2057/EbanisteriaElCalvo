...
import type { ServicesGridBlockProps } from "@/features/blocks/blocks/services-grid/services-grid.schema";

export function ServicesGridStatic(props: ServicesGridBlockProps) {
	const gridCols = {
		...
		<section className="py-12 md:py-24 bg-surface relative" id="servicios">
			...
			<div className="max-w-[1400px] mx-auto px-4 md:px-10 relative">
				<div className="text-center mb-16">
					...
					<h2 className="font-headline-md text-headline-md text-primary">{props.title}</h2>
				</div>
